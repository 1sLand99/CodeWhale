...
pub const ALL_MESSAGE_IDS: &[MessageId] = &[
    ...
    MessageId::ConfigChoiceRailPinned,
    MessageId::ConfigChoiceStatusCw,
    MessageId::ConfigChoiceStatusWhale,
    ...
    MessageId::ConfigChoiceDetailRailPinned,
    ...
    MessageId::ConfigChoiceDetailOceanDeepsea,
    MessageId::ConfigChoiceDetailOceanFlat,
    ...
    MessageId::ConfigHintOceanTreatment,
