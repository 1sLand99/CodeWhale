...
Codewhale — агент с открытым исходным кодом, который помогает разрабатывать программы, работать с файлами и автоматизировать повседневные задачи с помощью выбранных вами моделей. Начните с задачи в терминале и подключите облачную или локальную модель. Если большую работу нужно распределить между разными моделями и ролями, можно подключить команду агентов.
