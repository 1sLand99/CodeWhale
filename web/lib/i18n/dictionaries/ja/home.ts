...
export const home: HomeDict = {
  ...
  availability: [
    ["ターミナル", "リリース済み", "npm、Cargo、そして Linux・macOS・Windows 向けのビルド済みバイナリ。Android の Termux はプレビューです。"],
    ["ウェブアプリ", "アカウントのサインインが利用可能", "app.codewhale.net でサインインまたはアカウント作成。ブラウザのワークベンチ自体は開発プレビューです。"],
