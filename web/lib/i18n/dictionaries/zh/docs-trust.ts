...
export const docsTrust: DocsTrustDict = {
  ...
  telemetryLead: "0.9.12 源码中的匿名使用计数默认关闭。采集要求明确接受列明 Codewhale 和 PostHog 的第 4 版告知。显示首次运行提示不代表同意，已有的持久关闭选项始终有效。",
  telemetry: [
    ["永远不收集", "对话、代码、prompt、文件、文件/仓库/分支名、模型内容、凭据，以及任何逐轮或逐工具的时间线。"],
    ["同意后发送", "版本与平台类别、会话时长与结果、功能与错误计数、封闭枚举，以及一个每 90 天轮换的随机安装 id。"],
