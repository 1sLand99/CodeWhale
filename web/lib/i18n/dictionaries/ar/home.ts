...
export const home: HomeDict = {
  ...
  modelsBody:
    "اربط مزوّدًا مستضافًا مدعومًا أو بوابة أو خادم نماذج محليًا. تحقّق من المزوّد والنموذج قبل البدء. قد يتطلب الخادم المحلي أيضًا المصادقة.",
  modelsFacts: [
  ...
  availability: [
    ["الطرفية", "صدرت", "ملفات GitHub Releases الثنائية للينكس وmacOS وويندوز؛ npm وCargo بدائل. أندرويد على Termux معاينة."],
    ["تطبيق الويب", "تسجيل الدخول والتحكم عن بُعد متاحان", "سجّل الدخول أو أنشئ حسابًا، ثم اكتب /rc في جلسة محلية قيد التشغيل لمتابعة الجلسة نفسها من المتصفح. ما تبقّى من طاولة العمل في المتصفح ما زال معاينة تطوير."],
