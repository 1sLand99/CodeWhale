...
export const home: HomeDict = {
  ...
  availability: [
    ...
    ["Aplikacja webowa", "Logowanie do konta dostępne", "Zaloguj się lub załóż konto na app.codewhale.net. Sam warsztat w przeglądarce to wciąż podgląd deweloperski."],
