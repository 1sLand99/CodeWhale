...
export const TOOLS_COPY = {
  ...
  rows: [
    ...
    { name: "request_user_input", detail: { en: "Ask the person a question and wait for the answer. Hosts that cannot show a question keep it unavailable.", zh: "向用户提问并等待回答。无法显示提问的宿主不会提供此工具。" } },
