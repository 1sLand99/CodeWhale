    ...
    "sections": [
      {
        ...
        "items": [
          ...
          "Voice status is localized, ASCII-mode markers are distinct, and the cursor honours NO_COLOR (#5846)."
        ],
        "itemCount": 13
      },
      {
      ...
      },
      {
        "heading": "CI",
        "items": [
          "Fork pull requests stay under the macOS runner limit and the Actions cache stays under its cap (#6406).",
