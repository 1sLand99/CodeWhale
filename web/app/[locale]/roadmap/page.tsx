...
const tracksEn = [
  ...
  },
  {
    title: "Ruled out",
    items: [
      { title: "Silent or content-level telemetry", note: "The 0.9.12 source keeps anonymous usage counting off unless current processor consent is explicitly accepted; every opt-out remains effective. What stays ruled out: conversations, code, prompts, files, model content, credentials, per-turn or per-tool timelines, collection hidden from the user, and any third-party ad or analytics SDK in the runtime binary. A selected hosted provider still receives the context required for its model turn; loopback routes can keep inference local." },
