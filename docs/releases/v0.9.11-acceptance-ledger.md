...
| GitHub/CI | None in this local lane | Fetch, pull, push, API/`gh`, PRs, issues, reviews, merges, tags, releases, and CI queries require reopened authority |
...
- Do not use GitHub or the network for repository state.
