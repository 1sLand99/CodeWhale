...
This branch describes the **v0.9.3 source candidate**. Install commands that use
...
combinations. The table below is the intended v0.9.3 candidate matrix;
...
⁴ The v0.9.3 source-candidate npm wrapper recognizes Android arm64 and resolves
...
The v0.9.3 candidate build runs on Ubuntu 24.04, so it can require `GLIBC_2.39`.
...
older systems without error. The v0.9.3 candidate GNU arm64 asset is built on
