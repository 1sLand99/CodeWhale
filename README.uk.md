...
- **Настільний застосунок Codewhale (GPUI):** нативний настільний застосунок, що розробляється в окремому репозиторії, — напрям клієнта продукту для користувачів, які увійшли. Розміщений вебзастосунок на app.codewhale.net буде перебудовано за його зразком; маркетинговий сайт, вхід, оплата, юридичні сторінки та сторінки завантаження залишаються у вебі. Відомості про доступність наведено на [сторінці продукту](https://codewhale.net/en/product).
...
- [Уся документація](docs/README.md)
