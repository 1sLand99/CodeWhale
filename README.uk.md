...
Codewhale — агент із відкритим кодом, який допомагає розробляти програми, працювати з файлами й автоматизувати повсякденні завдання за допомогою обраних вами моделей. Почніть із завдання в терміналі та під’єднайте хмарну або локальну модель. Якщо більшу роботу потрібно розподілити між різними моделями й ролями, можна залучити команду агентів.
