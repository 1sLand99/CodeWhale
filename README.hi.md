...
Codewhale एक ओपन सोर्स एजेंट है जो आपकी पसंद के मॉडल से सॉफ़्टवेयर बनाने, फ़ाइलों पर काम करने और रोज़मर्रा के कामों को स्वचालित करने में मदद करता है। टर्मिनल में किसी काम से शुरुआत करें और होस्ट किया गया या लोकल मॉडल जोड़ें। बड़े काम को अलग-अलग मॉडल और भूमिकाओं में बाँटना हो, तो आप एजेंटों की टीम भी बना सकते हैं।
